    ...
    extend: {
      ...
      colors: {
        ...
        primary: {
          ...
          "glow-strong": "hsl(var(--primary-glow-strong))",
        },
        secondary: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px hsl(var(--primary-glow)), 0 0 40px transparent" },
          "50%": { boxShadow: "0 0 40px hsl(var(--primary-glow-strong)), 0 0 80px hsl(var(--primary-glow))" },
        },
        "orb-float": {
